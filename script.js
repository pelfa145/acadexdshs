...
const DEFAULT_PAPERS = [
    {
        id: 1,
        title: "Machine Learning Applications in Adaptive Educational Assessment Systems",
        author: "Maria Santos",
        strand: "ICT",
        category: "Capstone",
        year: "2025-2026",
        abstract: "This research explores the implementation of machine learning algorithms to create adaptive assessment systems. By analyzing student response patterns in real-time, the system adjusts question difficulty and content to provide personalized learning paths. The study demonstrates a 24% improvement in student engagement and a 15% increase in retention rates compared to traditional static testing methods.",
        keywords: ["machine learning", "education", "AI", "adaptive assessment", "python"],
        fileName: "ml_adaptive_assessment.pdf",
    ...
    {
        id: 2,
        title: "Socio-Economic Impacts of Urban Vertical Farming in Metro Manila",
        author: "John Reyes",
        strand: "STEM",
        category: "Thesis",
        year: "2025-2026",
        abstract: "A comprehensive study examining the feasibility and socio-economic benefits of implementing vertical farming solutions in high-density urban areas of Metro Manila. The research utilizes cost-benefit analysis and community surveys to evaluate potential impacts on local food security, employment, and carbon footprint reduction.",
        keywords: ["urban farming", "sustainability", "agriculture", "economics"],
        fileName: "urban_farming_manila.pdf",
    ...
    {
        id: 3,
        title: "The Evolution of Filipino Dialects in the Digital Age: A Linguistic Analysis",
        author: "Sarah Chen",
        strand: "HUMSS",
